package com.sadgames.dicegame.ui.colorpicker;
...
public class AmbilWarnaDialogFragment extends DialogFragment implements View.OnTouchListener, View.OnClickListener {
    ...
    private void initView() {
        ...
        mEditName = (EditText) mParentView.findViewById(R.id.edit_name);
        ...
        final int id = v.getId();
            ...
            if (id == R.id.ambilwarna_btn_no) {
                ...
                if (TextUtils.isEmpty(mEditName.getText().toString())){
                    mEditName.setError(getString(R.string.blank_name_error));
                }
                else {
                    if (mListener != null)
                        mListener.onOk(this, getColor(), mEditName.getText().toString());
