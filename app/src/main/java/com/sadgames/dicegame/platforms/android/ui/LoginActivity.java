...
public class LoginActivity extends BaseActivityWithMenu implements LoaderCallbacks<Cursor> {
    ...
    protected boolean handleWebServiceResponseAction(Context context, Intent intent) {
        if (intent.getAction().equals(RestApiService.ACTION_LOGIN_RESPONSE)){
            ...
            if (response.getId() != null) {
                getSysUtilsWrapper().getSettingsManager().setAuthToken(response.getId());
                getSysUtilsWrapper().getSettingsManager().setUserName(mEmailView.getText().toString());
                getSysUtilsWrapper().getSettingsManager().setUserPass(mPasswordView.getText().toString());
    ...
    public void onStart() {
        ...
        Action viewAction = Action.newAction(
                ...
                Uri.parse("android-app://com.sadgames.dicegame/http/host/path")
        );
