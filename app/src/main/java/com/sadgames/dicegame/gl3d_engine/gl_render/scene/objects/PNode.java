...
import com.sadgames.dicegame.gl3d_engine.gl_render.GLRenderConsts;
...
public abstract class PNode extends BitmapTexturedObject {
    ...
    public PNode(ISysUtilsWrapper sysUtilsWrapper, GLRenderConsts.GLObjectType type, GLShaderProgram program, int color,
                 float mass, int tag) {
