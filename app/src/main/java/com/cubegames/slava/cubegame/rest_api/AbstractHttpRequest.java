...
import com.cubegames.slava.cubegame.rest_api.model.BasicEntity;
...
import com.cubegames.slava.cubegame.rest_api.model.MyCollectionResponse;
...
import static com.cubegames.slava.cubegame.rest_api.RestConst.NET_CONNECT_TIMEOUT_MILLIS;
import static com.cubegames.slava.cubegame.rest_api.RestConst.NET_READ_TIMEOUT_MILLIS;
import static com.cubegames.slava.cubegame.rest_api.RestConst.PARAM_HEADER_AUTH_TOKEN;
import static com.cubegames.slava.cubegame.rest_api.RestConst.URL_DELETE;
import static com.cubegames.slava.cubegame.rest_api.RestConst.URL_FIND;
import static com.cubegames.slava.cubegame.rest_api.RestConst.URL_LIST;
import static com.cubegames.slava.cubegame.rest_api.RestConst.URL_NEW;
import static com.cubegames.slava.cubegame.rest_api.RestConst.URL_UPDATE;
...
public abstract class AbstractHttpRequest<T extends BasicEntity>{
    ...
    public final String getAuthToken() {
        return SettingsManager.getInstance(sysUtilsWrapper).getAuthToken();
    }

    public final String getBaseUrl() {
        return SettingsManager.getInstance(sysUtilsWrapper).getWebServiceUrl();
    }
