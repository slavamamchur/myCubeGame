...
import com.cubegames.slava.cubegame.game_logic.items.ChipObject;
import com.cubegames.slava.cubegame.game_logic.items.DiceObject;
import com.cubegames.slava.cubegame.game_logic.items.GameMapObject;
import com.cubegames.slava.cubegame.gl3d_engine.gl_render.IGameEventsCallBack;
import com.cubegames.slava.cubegame.gl3d_engine.gl_render.MapGLRenderer;
import com.cubegames.slava.cubegame.gl3d_engine.gl_render.scene.GLAnimation;
...
import com.cubegames.slava.cubegame.gl3d_engine.gl_render.scene.objects.GameItemObject;
import com.cubegames.slava.cubegame.gl3d_engine.gl_render.scene.objects.PNode;
import com.cubegames.slava.cubegame.gl3d_engine.gl_render.scene.objects.TopographicMapObject;
import com.cubegames.slava.cubegame.gl3d_engine.gl_render.scene.objects.materials.textures.AbstractTexture;
import com.cubegames.slava.cubegame.gl3d_engine.gl_render.scene.objects.materials.textures.BitmapTexture;
...
import com.cubegames.slava.cubegame.rest_api.model.Game;
import com.cubegames.slava.cubegame.rest_api.model.GameInstance;
import com.cubegames.slava.cubegame.rest_api.model.GameMap;
import com.cubegames.slava.cubegame.rest_api.model.players.InstancePlayer;
import com.cubegames.slava.cubegame.rest_api.model.points.AbstractGamePoint;
import com.cubegames.slava.cubegame.rest_api.model.points.PointType;
...
import static com.cubegames.slava.cubegame.game_logic.GameConsts.DUDVMAP_TEXTURE;
import static com.cubegames.slava.cubegame.game_logic.GameConsts.NORMALMAP_TEXTURE;
import static com.cubegames.slava.cubegame.game_logic.GameConsts.ROLLING_DICE_SOUND;
import static com.cubegames.slava.cubegame.game_logic.GameConsts.SEA_BOTTOM_TEXTURE;
import static com.cubegames.slava.cubegame.gl3d_engine.gl_render.GLRenderConsts.CHIP_MESH_OBJECT;
import static com.cubegames.slava.cubegame.gl3d_engine.gl_render.GLRenderConsts.DICE_MESH_OBJECT_1;
import static com.cubegames.slava.cubegame.gl3d_engine.gl_render.GLRenderConsts.GLObjectType.TERRAIN_OBJECT;
import static com.cubegames.slava.cubegame.gl3d_engine.gl_render.GLRenderConsts.TERRAIN_MESH_OBJECT;
import static com.cubegames.slava.cubegame.gl3d_engine.gl_render.scene.GLScene.CAMERA_ZOOM_ANIMATION_DURATION;
import static com.cubegames.slava.cubegame.rest_api.RestApiService.ACTION_ACTION_SHOW_TURN_INFO;
import static com.cubegames.slava.cubegame.rest_api.RestApiService.ACTION_MAP_IMAGE_RESPONSE;
import static com.cubegames.slava.cubegame.rest_api.RestApiService.ACTION_UPLOAD_IMAGE_RESPONSE;
import static com.cubegames.slava.cubegame.rest_api.RestApiService.EXTRA_DICE_VALUE;
import static com.cubegames.slava.cubegame.rest_api.RestApiService.EXTRA_ERROR_OBJECT;
import static com.cubegames.slava.cubegame.rest_api.RestApiService.startActionMooveGameInstance;
...
public class MapFragment extends Fragment implements IGameEventsCallBack {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        sysUtilsWrapper = new AndroidSysUtilsWrapper(getContext());
