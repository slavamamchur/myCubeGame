    ...
    protected boolean handleWebServiceResponseAction(Context context, Intent intent) {
        if (intent.getAction().equals(RestApiService.ACTION_LOGIN_RESPONSE)){
            ...
            if (response.getId() != null) {
                SettingsManager.getInstance(getSysUtilsWrapper()).setAuthToken(response.getId());
                SettingsManager.getInstance(getSysUtilsWrapper()).setUserName(mEmailView.getText().toString());
                SettingsManager.getInstance(getSysUtilsWrapper()).setUserPass(mPasswordView.getText().toString());
