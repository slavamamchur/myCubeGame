...
public class ColorShapeObject extends BitmapTexturedObject {

    private float[] vertexes;

    public ColorShapeObject(Context context, GLShaderProgram program, int color) {
        super(context, GLRenderConsts.GLObjectType.CHIP_OBJECT, program, color);
    }
    ...
    protected void createVertexesVBO() {
        vertexes = new float[]{
                // Front face
               -0.05f, 0.1f, 0.05f,   0f,   1f,
                   0f, 0.2f,    0f, 0.5f, 0.5f,
                0.05f, 0.1f, 0.05f,   1f,   1f,

                // Right face
                0.05f, 0.1f, 0.05f,   1f,   1f,
                   0f, 0.2f,    0f, 0.5f, 0.5f,
                0.05f, 0.1f,-0.05f,   1f,   0f,
