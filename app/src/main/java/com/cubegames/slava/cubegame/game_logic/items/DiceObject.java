package com.cubegames.slava.cubegame.game_logic.items;
...
import com.cubegames.slava.cubegame.gl3d_engine.utils.MathUtils;
...
import static com.cubegames.slava.cubegame.game_logic.GameConsts.DICE_TEXTURE;
import static com.cubegames.slava.cubegame.gl3d_engine.gl_render.GLRenderConsts.DICE_MESH_OBJECT_1;
import static com.cubegames.slava.cubegame.gl3d_engine.gl_render.GLRenderConsts.GLObjectType.GAME_ITEM_OBJECT;
...
public class DiceObject extends GameItemObject {
    ...
    @Override
    protected void createVertexesVBO() { //TODO: wrong order ??? vertex attribute index out of boundary is detected. Skipping corresponding vertex attribute. -> 2d box ?
